...
import { WeekDaySelector } from "./weekly-calendar/WeekDaySelector";
import { DayContent } from "./weekly-calendar/DayContent";
import { Availability } from "./weekly-calendar/types";
...
const WeeklyCalendar = ({ onAvailabilityChange, initialAvailability = [] }: WeeklyCalendarProps) => {
  const [selectedDay, setSelectedDay] = useState<number>(1); // Start with Monday (1)
...
export { type Availability } from "./weekly-calendar/types";
